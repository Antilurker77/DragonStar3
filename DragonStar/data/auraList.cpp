...
static std::unordered_map<AuraID, AuraData> initList() {
	...
	list[AuraID::DustDevil] = [] {
		AuraData ad;

		ad.Name = "Dust Devil";
		ad.Icon = "placeholder.png";
		ad.AuraID = AuraID::DustDevil;
		...
		ad.StatMods = {
			{
				StatMod(StatModType::Accuracy, ad.Values[0][0])
			}
		};
		...
		ad.GetDescription = [Values = ad.Values](Actor* user, EventOptions& eventOptions, int rank, Aura* aura){
			...
			value = std::to_string(Values[0][rank] * -1);
			desc = "Decreases accuracy by " + value + ".";
	...
	list[AuraID::GlovesOfAcceleration] = [] {
		AuraData ad;

		ad.Name = "Gloves of Acceleration";
		ad.Icon = "placeholder.png";
		ad.AuraID = AuraID::GlovesOfAcceleration;
	...
	list[AuraID::IcyJet] = [] {
		...
		ad.BaseDuration = { 100, 100, 100, 100, 100 };
		ad.MaxDuration = { 100, 100, 100, 100, 100 };
		ad.MaxStacks = { 1, 1, 1, 1, 1 };
	...
	list[AuraID::SiegeBreaker] = [] {
		AuraData ad;

		ad.Name = "Siege Breaker";
		ad.Icon = "placeholder.png";
		ad.AuraID = AuraID::SiegeBreaker;
	...
	list[AuraID::SwiftGauntlets] = [] {
		AuraData ad;

		ad.Name = "Swift Gauntlets";
		ad.Icon = "placeholder.png";
		ad.AuraID = AuraID::SwiftGauntlets;
		...
		ad.StatMods = {
			{
				StatMod(StatModType::DoubleStrikeChance, ad.Values[0][0])
			}
		};
		...
		ad.GetDescription = [Values = ad.Values](Actor* user, EventOptions& eventOptions, int rank, Aura* aura){
			...
			value = std::to_string(Values[0][rank] / 10);
			desc = "Increases double strike chance by " + value + "%.";
	...
	list[AuraID::Waterfall] = [] {
		AuraData ad;

		ad.Name = "Waterfall";
		ad.Icon = "placeholder.png";
		ad.AuraID = AuraID::Waterfall;
		...
		ad.StatMods = {
			{ StatMod(StatModType::MPCostReduction, ad.Values[0][0], Category::Spell) },
			{ StatMod(StatModType::MPCostReduction, ad.Values[0][1], Category::Spell) },
			{ StatMod(StatModType::MPCostReduction, ad.Values[0][2], Category::Spell) },
			{ StatMod(StatModType::MPCostReduction, ad.Values[0][3], Category::Spell) },
			{ StatMod(StatModType::MPCostReduction, ad.Values[0][4], Category::Spell) }
		};
		...
		ad.GetDescription = [Values = ad.Values](Actor* user, EventOptions& eventOptions, int rank, Aura* aura){
			...
			value = std::to_string(Values[0][rank] / 10);
			desc = "Reduces the MP cost of your next spell by " + value + "%.";
