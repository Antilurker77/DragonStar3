...
static std::unordered_map<StatModType, std::string> statMap = {
	...
	{StatModType::CooldownReduction, "Cooldown Reduction"},
	{StatModType::HPCostReduction, "HP Cost Reduction"},
	{StatModType::MPCostReduction, "MP Cost Reduction"},
	{StatModType::SPCostReduction, "SP Cost Reduction"},
